...
public class VideoSearchRvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public VideoSearchRvAdapter(Context context) {
  ...
  public static class BodyViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bindViews(ImageDetails item, int position) {
      Picasso.get()
      ...
      itemView.setOnClickListener(
          v -> {
            ...
            intent.putExtra(VideoDetailActivity.EXTRA_WINDOW_TITLE, item.getName());

            // Activity options for transitions
